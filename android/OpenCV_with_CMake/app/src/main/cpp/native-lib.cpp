...
Java_com_androidapp_opencv_1with_1cmake_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject thiz,
                                                                      jlong matAddrInput,
                                                                      jlong matAddrResult) {
...
Java_com_androidapp_opencv_1with_1cmake_MainActivity_loadCascade(JNIEnv *env, jobject thiz,
...
Java_com_androidapp_opencv_1with_1cmake_MainActivity_detect(JNIEnv *env, jobject thiz,
